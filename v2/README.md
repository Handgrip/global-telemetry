...
| Feature | v1 | v2 |
|---------|----|----|
| Probing | Custom Go code | blackbox-exporter |
| Metrics collection | Custom Remote Write | OTel Collector |
| Target discovery | Custom config fetch | Prometheus http_sd |
| Host metrics | None | OTel hostmetrics receiver |
| Code to maintain | ~1200 lines Go | 0 (config only) |
| Probe types | ICMP, HTTP | ICMP, HTTP, TCP, DNS, gRPC |
