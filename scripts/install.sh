...
# Usage: curl -sSL https://cdn.jsdelivr.net/gh/Handgrip/global-telemetry@main/scripts/install.sh | bash
...
probe_name: "changeme"
config_url: "https://cdn.jsdelivr.net/gh/Handgrip/global-telemetry@main/target.json"
